      ...
      <div className="container mx-auto px-4 py-12">
        {loading ? (
          ...
          <div className="text-center max-w-lg mx-auto py-24">
            ...
            <Link
              href="/admin/blogs/new"
              className="inline-flex items-center gap-2 px-6 py-3 text-sm font-medium text-white bg-cyan-500/20 border border-cyan-500/40 rounded-lg hover:bg-cyan-500/30 transition-colors"
            >
              <Plus className="h-4 w-4" />
              Create first post
            </Link>
          ...
          <div className="space-y-4">
            {posts.map((post) => (
              ...
              >
                <div className="relative h-16 w-24 shrink-0 rounded-lg overflow-hidden bg-slate-800">
                  {post.coverImage ? (
                    <Image
                      src={post.coverImage}
                      alt=""
