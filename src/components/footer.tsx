  ...
  return (
    <footer className="relative border-t border-slate-800/60 bg-slate-950">
      ...
      <div className="relative w-full max-w-full px-4 py-12 sm:px-6 lg:px-8 xl:px-12">
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-5">
            <Link href="/" className="group inline-flex items-center gap-2.5">
              ...
              />
              <span className="dec-title text-lg font-semibold tracking-tight text-slate-200 sm:text-xl">
                EIPsInsight
              </span>
            </Link>
            ...
            <div className="mt-5 flex items-center gap-2">
              <a
                ...
                className="rounded-md p-2 text-slate-500 transition-colors hover:bg-slate-800/50 hover:text-slate-300"
                aria-label="GitHub"
              >
        ...
        {/* Bottom bar */}
        <hr className="mt-10 border-slate-800/60" />
        <div className="mt-6 flex flex-col items-center justify-between gap-4 sm:flex-row sm:gap-6">
          <p className="text-center text-xs text-slate-600">
            ...
            <span className="text-emerald-400/80">Ethereum</span> community.
          </p>
          <a
            href="https://github.com/ethereum/EIPs"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-xs text-slate-600 transition-colors hover:text-slate-500"
          >
